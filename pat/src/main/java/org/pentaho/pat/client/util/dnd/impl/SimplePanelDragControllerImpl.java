...
public class SimplePanelDragControllerImpl extends AbstractDragController {
	 ...
	 */
	public SimplePanelDragControllerImpl(AbsolutePanel boundaryPanel,
		...
		// dropControllerCollection = new
		// DropControllerCollection(dropControllerList);
	}
	...
	protected void restoreSelectedWidgetsLocation() {
		for (Widget widget : context.selectedWidgets) {
			...
			// TODO simplify after enhancement for issue 1112 provides
			// InsertPanel
			// interface
	...
	protected void saveSelectedWidgetsLocationAndStyle() {
		...
		for (Widget widget : context.selectedWidgets) {
			 ...
			 * else if (info.initialDraggableParent instanceof FastTreeItem) {
			 ...
			 * SimplePanelDragControllerImpl.class.getName() +
