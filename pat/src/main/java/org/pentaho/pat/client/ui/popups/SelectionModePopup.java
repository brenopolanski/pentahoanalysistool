...
public class SelectionModePopup extends PopupPanel {
	...
	public class SelectionModeClearCommand implements Command {
		...
		public final void execute() {
			...
			ServiceFactory.getQueryInstance().clearSelection(Pat.getSessionID(), Pat.getCurrQuery(), dimName, dimSelections, new AsyncCallback<Object>() {
	...
	public class SelectionModeCommand implements Command {
		...
		public final void execute() {
			...
			ServiceFactory.getQueryInstance().createSelection(Pat.getSessionID(), Pat.getCurrQuery(), dimName, dimSelections, selection, new AsyncCallback<Object>() {
