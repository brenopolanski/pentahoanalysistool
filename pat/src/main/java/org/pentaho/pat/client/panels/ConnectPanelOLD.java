...
public class ConnectPanelOLD extends WindowPanel implements SourcesConnectionEvents {
			...
			ServiceFactory.getInstance().connect(connectionStr,
				...
				public void onSuccess(Object result) {
					...
					if (booleanResult.booleanValue()) {
						...
						connectionListeners
						.fireConnectionMade(ConnectPanelOLD.this);
					} else {
						setConnectionEstablished(false);
						connectionListeners
						.fireConnectionBroken(ConnectPanelOLD.this);
					}
					connectBtn
