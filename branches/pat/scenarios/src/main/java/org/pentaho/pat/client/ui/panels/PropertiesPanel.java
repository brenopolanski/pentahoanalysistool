    ...
    public PropertiesPanel(final DataPanel dPanel, PanelUtil.PanelType pType) {
        ...
        createScenarioButton.addClickHandler(new ClickHandler() {
            ...
            public void onClick(final ClickEvent arg0) {
                ...
                /*ServiceFactory.getQueryInstance().alterCell(queryId, Pat.getSessionID(), Pat.getCurrScenario(), Pat.getCurrConnectionId(), 1,"123", new AsyncCallback<CellDataSet>(){
                ...
                ServiceFactory.getSessionInstance().createNewScenario(Pat.getSessionID(), Pat.getCurrConnection().getId(), new AsyncCallback<String>(){
                    public void onFailure(final Throwable arg0){
                	...
                	ServiceFactory.getQueryInstance().moveDimension(Pat.getSessionID(), Pat.getCurrQuery(), IAxis.FILTER, "Scenario", new AsyncCallback(){

						public void onFailure(Throwable arg0) {
							// TODO Auto-generated method stub
							MessageBox.error("#Fail", "cock");
						}

						public void onSuccess(Object arg0) {
							ServiceFactory.getQueryInstance().createSelection(Pat.getSessionID(), Pat.getCurrQuery(), 
									"[Scenario].["+Pat.getCurrScenario()+"]", ObjectType.MEMBER, SelectionType.MEMBER, new AsyncCallback(){
