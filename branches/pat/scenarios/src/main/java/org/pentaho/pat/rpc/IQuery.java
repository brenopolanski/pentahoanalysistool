...
public interface IQuery extends RemoteService {
    ...
    CellDataSet alterCell(String sessionId, String queryId, String connectionId, String scenarioId, 
	    int ordinal, int newCellValue)throws RpcException;
     ...
     */
    @Secured( {"Users"})
    int clearSelection(String sessionId, String queryId, String uniqueName, List<String> currentSelections)
            throws RpcException;
	...
	@Secured( {"Users"})
    void pushDownMeasureMember(String sessionID, String currQuery, IAxis axis, String dimension,
			int i, int j) throws RpcException;

	@Secured( {"Users"})
	void pullUpMeasureMember(String sessionID, String currQuery, IAxis axis, String dimension,
			int i, int j) throws RpcException;
