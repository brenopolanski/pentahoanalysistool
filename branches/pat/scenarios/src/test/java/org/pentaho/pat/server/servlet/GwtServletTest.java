...
public class GwtServletTest extends AbstractServletTest {
    ...
    public void testConnections() throws Exception
    {
        ...
        String[][] currentConnectionsArray = runOnDatasource("select id, driverClassName, name, password, schemadata, type, url,connectonstartup, username from pat_connections"); //$NON-NLS-1$
        ...
        currentConnectionsArray = runOnDatasource("select id, driverClassName, name, password, schemadata, type, url, connectonstartup, username from pat_connections"); //$NON-NLS-1$
