...
$E=(evt?$(this):$Ps[evt_or_pane]),pane=$E.data("layoutEdge"),o=options[pane],s=state[pane],$P=$Ps[pane];if(s.isClosed||s.isResizing)
return;else if(o.slideTrigger_close=="click")
close_NOW();else if(o.preventQuickSlideClose&&_c.isLayoutBusy)
return;else if(o.preventPrematureSlideClose&&evt&&$.layout.isMouseOverElem(evt,$P))
return;else if(evt)
timer.set(pane+"_closeSlider",close_NOW,_c[pane].isMoving?1000:300);else
close_NOW();function close_NOW(evt){if(s.isClosed)
...
o=options[pane],$P=$Ps[pane],$R=$Rs[pane],trigger=o.slideTrigger_open;if(!$R||!o.slidable)return;if(trigger.match(/mouseover/))
...
if(!skipCallback&&state.initialized&&s.isVisible){_execCallback(pane,o.onresize_end||o.onresize);resizeNestedLayout(pane);}});};var resizeAll=function(){var
...
_execCallback(pane,o[pane].onresize_end||o[pane].onresize);resizeNestedLayout(pane);});_execCallback(null,o.onresizeall_end||o.onresizeall);};var resizeNestedLayout=function(pane){var
