...
public interface SessionService extends Service {
     ...
     * 
     * @param userId
     *            The user unique id to validate.
     * @throws SecurityException
     ...
     * 
     * @param userId
     *            The owner of the session to create.
     ...
     * 
     * @param userId
     *            The owner of the session to close.
     * @param sessionId
     ...
     * 
     * @param userId
     *            The owner of the required session.
     * @param sessionId
     ...
     * 
     * @param userId
     *            The owner of the session into which we want to store.
     * @param sessionId
     *            The id of the session into which to store the variable.
     * @param key
     *            The key under which to store the variable.
     * @param value
     ...
     *            The owner of the session.
     * @param sessionId
     *            The session od from which we want a variable retreived.
     * @param key
     ...
     *            The owner of the session.
     * @param sessionId
     *            The id of the session that contains the variable.
     * @param key
     *            The key under which the variable is stored.
     */
    @Secured( {"Users"})
     ...
     * 
     * @param userId
     *            The owner of the connection to establish.
     * @param sessionId
     *            The session id under which the connection will be stored.
     * @param connectionId
     ...
     *            The session id under which the connection will be stored.
     * @param sc
     *            A SavedConnection object describing the connection to establish.
     * @throws OlapException
     *             If the connection fails.
     */
    @Secured( {"Users"})
     ...
     * @param sessionId
     *            The session id under which the connection is
     * @param connectionId
     *            The sasved connection UUID for which we want the underlying native connection.
     ...
     *            The owner of the connection.
     * @param sessionId
     *            The session id that contains the connection
     * @param connectionId
     *            The connection UUID
     */
    @Secured( {"Users"})
     ...
     * 
     * @param userId
     *            The owner of the connection. The saved connection will be associated to his account.
     * @param connection
     ...
     * 
     * @param userId
     *            The owner of the connection to delete.
