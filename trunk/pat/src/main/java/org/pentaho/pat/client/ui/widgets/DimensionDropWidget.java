...
import org.pentaho.pat.client.deprecated.ui.panels.DimensionPanel;
import org.pentaho.pat.client.deprecated.ui.widgets.DimensionFlexTable;
import org.pentaho.pat.client.deprecated.util.FlexTableRowDropController;
...
public class DimensionDropWidget extends LayoutComposite  implements ConnectionListener, QueryListener{
	...
	private FlexTableRowDropController dimensionDropController;
	 ...
	 */
	public DimensionDropWidget(final String labelText, final Axis targetAxis, String orientation) {
	...
	public final void init(final String labelText, final Axis targetAxis) {
		...
		dropLabel.setStyleName("pat-dropLabel"); //$NON-NLS-1$
		dimensionTable.setStyleName("pat-dropTable"); //$NON-NLS-1$
	...
	@Override
	public void onLoad(){
		dimensionDropController = new FlexTableRowDropController(dimensionTable, dimAxis);
		DimensionPanel.getTableRowDragController().registerDropController(dimensionDropController);
		
	}
	
	@Override
	public void onUnload(){
	    DimensionPanel.getTableRowDragController().unregisterDropController(dimensionDropController);
	}
	/**
	...
	/* (non-Javadoc)
	 * @see org.pentaho.pat.client.deprecated.listeners.QueryListener#onQueryChange(com.google.gwt.user.client.ui.Widget)
	 */
