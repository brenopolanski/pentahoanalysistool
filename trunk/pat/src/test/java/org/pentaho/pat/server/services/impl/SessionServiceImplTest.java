...
public class SessionServiceImplTest extends AbstractServiceTest {
	...
	public void testSavedConnections() throws Exception
	{
        ...
        SavedConnection savedConn = this.sessionService.getConnection(userId, conn.getId()); //$NON-NLS-1$
        ...
        assertNull(this.sessionService.getConnection(userId, conn.getId())); //$NON-NLS-1$
